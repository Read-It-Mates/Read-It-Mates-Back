...
router.post("/", async (req, res) => {
  // 베스트셀러 페이지 URL
  const bestURL =
    "https://www.yes24.com/24/category/bestseller?CategoryNumber=002001052&sumgb=06&PageNumber=1&FetchSize=100";
  ...
  const bestCollection = db.collection("bestSellers2_13");
