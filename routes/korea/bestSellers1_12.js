...
router.post("/", async (req, res) => {
  try {
    // 베스트셀러 페이지 URL
    const bestURL =
      "https://www.yes24.com/24/category/bestseller?CategoryNumber=001001009&sumgb=06&PageNumber=1&FetchSize=100";
    ...
    const bestCollection = db.collection("bestSellers1_12");
