...
async function crawlPage(pageNumber) {
  try {
    const bestURL = `https://www.aladin.co.kr/shop/common/wbest.aspx?BestType=ForeignJapan&BranchType=7&CID=129547&page=${pageNumber}&cnt=300&SortOrder=1`;
...
router.post("/", async (req, res) => {
  try {
    ...
    const bestCollection = db.collection("bestSellers3_9");
